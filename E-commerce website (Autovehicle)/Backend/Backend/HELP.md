...
* The original package name 'com.example.automotive-vehicle-application ' is invalid and this project uses 'com.example.automotivevehicleapplication' instead.
